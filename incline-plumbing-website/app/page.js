...
export default function Home() {
  return (
    <main>
      ...
      <section className="hero" id="top">
        <div className="shell hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><a className="button" href="tel:+17195025709">Call Now</a><a className="button button-outline" href="#contact">Request Service</a></div>
      ...
      <section className="cta"><div className="shell cta-grid"><div><div className="eyebrow">NEED A PLUMBER?</div><h2>We show up. We solve it. You get back to what matters.</h2></div><div className="cta-actions"><a className="button light" href="tel:+17195025709">Call (719) 502-5709</a><a className="text-link" href="#contact">Request service online →</a></div></div></section>

      <section className="section shell contact" id="contact"><div className="contact-copy"><div className="eyebrow red">CONTACT US</div><h2>Tell us how we can help.</h2><p>Use this form to request service. Call or send us a message to request service.</p><div className="contact-lines"><a href="tel:+17195025709">(719) 922-3350</a><a href="mailto:inclineplumbing@gmail.com">inclineplumbinganddrain@gmail.com</a><span>Colorado Springs, Colorado</span></div></div><form className="form" action="mailto:inclineplumbing@gmail.com" method="post" encType="text/plain"><label>Name<input name="name" required placeholder="Your name" /></label><label>Phone<input name="phone" required placeholder="(719) 555-0000" /></label><label>Email<input name="email" type="email" placeholder="you@email.com" /></label><label>How can we help?<textarea name="message" required rows={5} placeholder="Tell us what is going on..." /></label><button className="button" type="submit">Request Service</button></form></section>

      <footer className="footer"><div className="shell footer-grid"><div className="footer-brand"><Image src="/incline-logo.png" alt="Incline Plumbing & Drain" width={145} height={145} /><p>Keeping Your Home at Peak Performance</p></div><div><b>Services</b><a href="#services">Plumbing Repairs</a><a href="#services">Drain Cleaning</a><a href="#services">Water Heaters</a></div><div><b>Company</b><a href="#about">About</a><a href="#areas">Service Area</a><a href="#contact">Contact</a></div><div><b>Get Service</b><a href="tel:+17195025709">(719) 502-5709</a><a href="mailto:inclineplumbing@gmail.com">Email Us</a></div></div><div className="shell footer-bottom">© 2026 Incline Plumbing & Drain. All rights reserved.</div></footer>
